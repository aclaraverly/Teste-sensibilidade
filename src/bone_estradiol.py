...
def bonerepair(y,t, E2_max):
  ...
  d_c1 = 1.0 #0.2 #12.79  
  k_2 = 2.0e-5 #0.000015 #0.0000372 #0.00000372
  k_3 = 5.0e-6 #0.000003 #0.000007 #0.0000007
  d_c2 = 0.1 #0.2 #0.5 #2.5
  ...
  q_bd = 2e-8 #0.00000001 #0.0000005 #0.00000005
  aed = 5.0e5 #4.71*10**6
  kmax = 0.015 #0.1
