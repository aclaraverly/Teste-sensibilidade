...
def bonerepair(y,t, E2_max):
  ...
  ke_1 = 48.0 #3.0 #48 max
  ke_2 = 48.0 #3.0 #48 max
  a_ed = 5*10**5 #era 4.71*10**6
  d_o = 0.156
  k_12 = 0.075
  k_21 = 0.005
  d_1 = 0.121
  ...
  d_c1 = 1.0 #0.2 #12.79  
  k_2 = 0.000015 #0.0000372 #0.00000372
  k_3 = 0.000003 #0.000007 #0.0000007
  d_c2 = 0.2 #0.5 #2.5
  ...
  p_bs = 0.0000001 #0.000000005 #0.00000005
  q_bd = 0.00000001 #0.0000005 #0.00000005
  aed = 5.0e5 #4.71*10**6
  kmax = 0.015 #0.1
