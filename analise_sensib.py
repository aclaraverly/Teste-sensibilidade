...
problem = {
    'num_vars': 4,
    'names': [ 'ke_1', 'ke_2', 'E2max', 'apm'],
    'bounds': [[0.0095, 0.0284], [0.0284, 0.75], [0.015, 0.045], [0.015, 0.045]] 
}  # 50% -/+
...
for params in param_values:
    ke_1, ke_2, E2max, apm = params
    sol = solve_ivp(bonerepair, [0, 10], yinit, args=(ke_1, ke_2, E2max, apm,))
