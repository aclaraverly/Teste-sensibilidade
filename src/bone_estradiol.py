...
def bonerepair(y,t, E2_max):
  ...
  ke_1 = 3.0 #48 max
  ke_2 = 3.0 #48 max
  a_ed = 4.71*10**5 #era 4.71*10**6
  d_o = 0.156
  k_12 = 0.075
  k_21 = 0.005
  d_1 = 0.121
  d_2 = 0.163
  k_o = 0.00005 #0.0000005
  k_1 = 0.00083 #0.0000083
  d_c1 = 0.2 #12.79  
  k_2 = 0.0000372 #0.00000372
  k_3 = 0.000007 #0.0000007
  d_c2 = 0.5 #2.5
  K_lm = 100000.0 # 1000000.0
  k_lb = 100000.0 #1000000.0
  d_b = 0.15
  p_cs = 0.0000003 #0.000003
  q_cd1 = 0.00003 #0.000003
  q_cd2 = 0.000002 #0.0000002
  p_bs = 0.000000005 #0.00000005
  q_bd = 0.0000005 #0.00000005
  aed = 4.71*10**6
  kmax = 0.015 #0.1
